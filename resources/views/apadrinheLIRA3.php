...
<body>
        ...
        <form>
            <div class="select-container">
                ...
                <select id="childName" required name="childName" onchange="showChildImage()">
                    ...
                    <option value="child1">Fernanda</option>
                    <option value="child2">Helena</option>
                    <option value="child3">Julieta</option>
                </select>
                <br>
    ...
    <script>
        function redirectToPage() {
            ...
            if (selectedChild) {
                // Redireciona para a página apadrinheLIRA4.html
                window.location.href = "/apadrinheLIRA4";
            } else {
...
<script>
    function showChildImage() {
        ...
        if (selectedValue === 'child1') {
            imageSrc = 'img/fernanda (Lira-e-Cia).jpg'; 
        } else if (selectedValue === 'child2') {
            imageSrc = 'img/helena (Lira-e-Cia).jpg'; 
        } else if (selectedValue === 'child3') {
            imageSrc = 'img/julieta (Lira-e-Cia).jpg'; 
        }
