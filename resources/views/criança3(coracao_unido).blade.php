...
@include('components.nav')
  ...
  <div class="comunidades">
    <div class="texto">
        <h2>Conheça o Felipe!</h2>
        <p>Felipe é um garoto de 10 anos, esperto e com um brilho nos olhos que reflete sua imaginação fértil. Ele adora construir coisas com peças de montar, criando mundos inteiros em sua mente onde tudo é possível. Seu passatempo favorito é ler livros de aventuras e mistério, sonhando com o dia em que poderá viver uma grande jornada.</p>
    </div>
    <!-- Imagem à direita -->
    <div class="imagem-comunidade">
        <img src="{{ asset('img/felipe (coracao_unido).jpg') }}" alt="Imagem do Lucas">
