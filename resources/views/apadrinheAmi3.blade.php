...
<body>
        ...
        <form>
            <div class="select-container">
                ...
                <select id="childName" required name="childName" onchange="showChildImage()">
                    ...
                    <option value="child1">Ana</option>
                    <option value="child2">Julia</option>
                    <option value="child3">Eloá</option>
                </select>
                <br>
    ...
    <script>
        function redirectToPage() {
            ...
            if (selectedChild) {
                // Redireciona para a página apadrinheAmi4.html
                window.location.href = "/apadrinheAmi4";
            } else {
    ...
    <script>
        function showChildImage() {
            ...
            if (selectedValue === 'child1') {
                imageSrc = 'img/ana (Amigos-do-Bem).jpg'; 
            } else if (selectedValue === 'child2') {
                imageSrc = 'img/julia (Amigos-do-Bem).jpg'; 
            } else if (selectedValue === 'child3') {
                imageSrc = 'img/eloá (Amigos-do-Bem).jpg'; 
            }
