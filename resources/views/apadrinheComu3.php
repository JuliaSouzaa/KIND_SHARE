...
<body>
        ...
        <form>
            <div class="select-container">
                ...
                <select id="childName" required name="childName" onchange="showChildImage()">
                    ...
                    <option value="child1">Maria</option>
                    <option value="child2">Betania</option>
                    <option value="child3">Nicolli</option>
                </select>
                <br>
    ...
    <script>
        function redirectToPage() {
            ...
            if (selectedChild) {
                // Redireciona para a página apadrinheRede4.html
                window.location.href = "/apadrinheRede4";
            } else {
...
<script>
    function showChildImage() {
        ...
        if (selectedValue === 'child1') {
            imageSrc = 'img/maria (Vozes-Comunidade).jpg'; 
        } else if (selectedValue === 'child2') {
            imageSrc = 'img/betania (Vozes-Comunidade).jpg'; 
        } else if (selectedValue === 'child3') {
            imageSrc = 'img/nicolli (Vozes-Comunidade).jpg'; 
        }
