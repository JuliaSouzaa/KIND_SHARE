...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/lista_necessidades.css') }}">
...
<div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="{{ asset('img/lista_necessidades.jpg') }}" class="d-block w-100" alt="...">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <div class="carousel-content">
                ...
                <div class="carousel-image">
                    <img src="{{ asset('img/lis_nece1.jpg') }}" class="img-fluid" alt="Imagem de doação">
                </div>
            </div>
        </div>
        ...
        <div class="carousel-item">
            <div class="carousel-content">
                ...
                <div class="carousel-image">
                    <img src="{{ asset('img/lis_nece2.jpg') }}" class="img-fluid" alt="Imagem de doação">
                </div>
            </div>
        </div>
    </div>
