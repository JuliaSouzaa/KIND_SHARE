...
<header>
    ...
    <div class="comunidades">
        <div class="texto">
            <h2>Conheça a Eloá!</h2>
            <p>Eloá tem 6 anos, é delicada, mas cheia de ideias criativas. Ela adora fazer teatros com suas bonecas, criando histórias emocionantes que fazem sua família rir e se emocionar. Eloá também é fã de cozinhar com a mãe, principalmente quando pode decorar cupcakes com confeitos coloridos.</p>
        </div>

        <!-- Imagem à direita -->
        <div class="imagem-comunidade">
            <img src="img/eloá (Amigos-do-Bem).jpg" alt="Imagem da Fernanda">
        </div>
    </div>
