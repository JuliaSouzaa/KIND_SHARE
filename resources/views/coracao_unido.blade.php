...
<div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000" >
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="img/coracao_unido.jpg" class="d-block w-100" alt="...">
...
<div class="comunidades">
    <div class="texto">
        <h2>Coração Unido</h2>
        <p>Na ONG <strong>Coração Unido</strong>, estamos profundamente comprometidos em transformar a vida de crianças e jovens em situação de vulnerabilidade. Nossa missão é proporcionar um acolhimento acolhedor e seguro, oferecendo apoio integral e contínuo. 
        Desde nossa fundação, temos trabalhado incansavelmente para garantir que cada criança tenha acesso a recursos essenciais, como alimentação, educação e cuidados. 
        Com uma rede de 15 centros especializados estrategicamente localizados, oferecemos serviços que vão desde a prevenção e intervenção até o desenvolvimento pessoal e a formação integral.
        </p>
    </div>
    ...
    <div class="imagem-comunidade">
        <div class="carrossel">
            <div class="carrossel-images">
                <img src="img/coracao_unido2.jpg" alt="Perfil ONG">
                <img src="img/coracao_unido3.jpg" alt="Perfil ONG">
                <img src="img/coracao_unido4.jpeg" alt="Perfil ONG">
            </div>
