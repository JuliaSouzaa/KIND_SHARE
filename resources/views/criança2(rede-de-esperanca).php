...
<header>
    ...
    <div class="comunidades">
        <div class="texto">
            <h2>Conheça a Pedro!</h2>
            <p>Pedro tem 5 anos, é pequeno, mas cheio de grandes sonhos. Ele ama tudo relacionado a animais e passa boa parte do dia imitando seus favoritos: o leão e o elefante. Sempre que encontra um bichinho, como uma formiga ou uma joaninha, fica encantado e tenta cuidar deles como se fossem seus amigos.</p>
        </div>
        <!-- Imagem à direita -->
        <div class="imagem-comunidade">
            <img src="img/pedro (Rede-Esperança).jpg" alt="Imagem da Fernanda">
        </div>
    </div>
