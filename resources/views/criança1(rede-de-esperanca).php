...
<header>
    ...
    <div class="comunidades">
        <div class="texto">
            <h2>Conheça a João!</h2>
            <p>João tem 11 anos, tem um talento especial para contar histórias engraçadas, que fazem todos caírem na risada. Ele é fã de futebol e passa horas praticando chutes no quintal. Quando não está jogando, adora ajudar a mãe na cozinha, aprendendo receitas e inventando novos sabores para sucos.</p>
        </div>
        <!-- Imagem à direita -->
        <div class="imagem-comunidade">
            <img src="img/joao (Rede-Esperança).jpg" alt="Imagem da Fernanda">
        </div>
    </div>
        ...
        <div class="cards">
            <div class="card">
                <a href="/criança2(rede-de-esperanca)">
                    <img src="img/pedro (Rede-Esperança).jpg" alt="Helena">
                    <h3>Pedro</h3>
                    <p>5 anos</p>
                </a>
            </div>
            ...
            <div class="card">
                <a href="/criança3(rede-de-esperanca)">
                    <img src="img/kaique (Rede-Esperança).jpg" alt="julieta">
                    <h3>Kaique</h3>
                    <p>4 anos</p>
                </a>
            </div>
